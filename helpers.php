<?php
     ...
     */
    function formatNumber(?string $number = null): string {
        $newNumber = $number ?? 0;
     ...
     */
    function formatValue(?float $value = null, int $e): string {
        $newValue = $value ?? 0;
     ...
     */
    function countDate(string $date): string {
     ...
     */
    function validateURLWithFilter(string $url): bool {
    ...
    function url(string $url): string {
        $environment = isLocalhost() ? DEVELOP_URL : PRODUCTION_URL;
     ...
     */
    function slugfy(string $text): string {
